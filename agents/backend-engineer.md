...
Create an individual scratchpad at `agent-memory/scratchpad/individual/backend-engineer-{YYYYMMDD-HHMM}.md`. Use it for working notes, hypothesis tracking, and intermediate state. No other agent reads this file. Delete or archive it when the task is complete.
